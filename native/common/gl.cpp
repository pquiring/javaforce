...
{
  jint *i2ptr = (jint*)e->GET_INT_ARRAY(i2,NULL);
  (*(void (*)(int,jint *))funcs[GLDELETEBUFFERS].func)(i1, i2ptr);
  e->RELEASE_INT_ARRAY(i2, i2ptr, JNI_ABORT);
}
  ...
  (JNIEnv *e, jclass c, jint i1, jintArray i2)
{
  ...
  e->RELEASE_INT_ARRAY(i2, i2ptr, 0);
}
...
{
  jint *i4ptr = NULL;
  if (i4 != NULL) (jint*)e->GET_INT_ARRAY(i4,NULL);
  ...
  if (i4 != NULL) e->RELEASE_INT_ARRAY(i4, i4ptr, JNI_ABORT);
  free(s3ptr);
  return ret;
}
...
{
  float *f4ptr = (jfloat*)e->GET_FLOAT_ARRAY(f4,NULL);
  (*(void (*)(int,int,int,float *))funcs[GLUNIFORMMATRIX4FV].func)(i1, i2, i3, f4ptr);
  e->RELEASE_FLOAT_ARRAY(f4, f4ptr, JNI_ABORT);
}
