...
Ant Tasks:
  ...
  graal
    - builds application native Library (should run after agent has generated config files and are packaged into application jar file)
    ...
    - the ant task 'executable' always generates an executable that will look for the Graal Library before looking for a standard JVM
