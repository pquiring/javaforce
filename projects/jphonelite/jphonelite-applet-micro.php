...
<center>
<applet code="PhoneAppletMicro" archive="jphonelite-signed.jar,javaforce-signed.jar,jna-signed.jar,bouncycastle-signed.jar" width=290 height=100><param name=userid value="<?php echo($_REQUEST['userid']); ?>"><param name=number value='18005551234'></applet>
</center>
</body>
</html>
