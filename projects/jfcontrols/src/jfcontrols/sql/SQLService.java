...
public class SQLService {
  ...
  private static void createDB() {
    ...
    sql.execute("insert into config (id, value) values ('hw_active','0')");
...
//    sql.execute("insert into listdata (lid,value,text) values (" +  id + "," + TagType.string + ",'string')");
    ...
    sql.execute("insert into listdata (lid,value,text) values (" +  id + ",2,'togglebutton')");
    sql.execute("insert into listdata (lid,value,text) values (" +  id + ",3,'light')");
    sql.execute("insert into listdata (lid,value,text) values (" +  id + ",4,'light3')");
    sql.execute("insert into listdata (lid,value,text) values (" +  id + ",5,'progressbar')");
    ...
    sql.execute("insert into cells (pid,x,y,w,h,comp,name,text,func,arg) values (" + id + ",0,4,3,1,'button','','SysDataTypes','setPanel','jfc_sdts')");
    sql.execute("insert into cells (pid,x,y,w,h,comp,name,text,func,arg) values (" + id + ",0,5,3,1,'button','','Panels','setPanel','jfc_panels')");
    sql.execute("insert into cells (pid,x,y,w,h,comp,name,text,func,arg) values (" + id + ",0,6,3,1,'button','','Functions','setPanel','jfc_funcs')");
    sql.execute("insert into cells (pid,x,y,w,h,comp,name,text,func,arg) values (" + id + ",0,7,3,1,'button','','Alarms','setPanel','jfc_alarm_editor')");
    sql.execute("insert into cells (pid,x,y,w,h,comp,name,text,func,arg) values (" + id + ",0,8,3,1,'button','','Config','setPanel','jfc_config')");
    sql.execute("insert into cells (pid,x,y,w,h,comp,name,text,func,arg) values (" + id + ",0,9,3,1,'button','','Watch','setPanel','jfc_watch')");
    sql.execute("insert into cells (pid,x,y,w,h,comp,name,text,func) values ("     + id + ",0,10,3,1,'button','','Logoff','jfc_logout')");
    ...
    sql.execute("insert into cells (pid,x,y,w,h,comp,name,text,func) values (" + id + ",1,1,3,1,'button','','Save','jfc_config_save')");
    sql.execute("insert into cells (pid,x,y,w,h,comp,name,text,func) values (" + id + ",5,1,4,1,'button','','Change Password','jfc_config_password')");
    if (!JF.isWindows()) {
      sql.execute("insert into cells (pid,x,y,w,h,comp,name,text) values (" + id + ",1,3,2,1,'label','','IP Addr')");
      sql.execute("insert into cells (pid,x,y,w,h,comp,name,tag) values (" + id + ",4,3,3,1,'textfield','','jfc_config_value_str_ip_addr')");
      sql.execute("insert into cells (pid,x,y,w,h,comp,name,text) values (" + id + ",1,4,2,1,'label','','IP Mask')");
      sql.execute("insert into cells (pid,x,y,w,h,comp,name,tag) values (" + id + ",4,4,3,1,'textfield','','jfc_config_value_str_ip_mask')");
      sql.execute("insert into cells (pid,x,y,w,h,comp,name,text) values (" + id + ",1,5,2,1,'label','','IP GW')");
      sql.execute("insert into cells (pid,x,y,w,h,comp,name,tag) values (" + id + ",4,5,3,1,'textfield','','jfc_config_value_str_ip_gateway')");
      sql.execute("insert into cells (pid,x,y,w,h,comp,name,text) values (" + id + ",1,6,2,1,'label','','IP DNS')");
      sql.execute("insert into cells (pid,x,y,w,h,comp,name,tag) values (" + id + ",4,6,3,1,'textfield','','jfc_config_value_str_ip_dns')");
    }
    ...
    sql.execute("insert into cells (pid,x,y,w,h,comp,name,text,arg) values (" + id + ",16,8,7,1,'combobox','backups','','jfc_config_backups')");
    sql.execute("insert into cells (pid,x,y,w,h,comp,name,text) values (" + id + ",1,9,20,1,'label','jfc_config_status','')");

//    if (JF.isPI()) {
      sql.execute("insert into cells (pid,x,y,w,h,comp,name,text) values (" + id + ",1,10,4,1,'label','','GPIO Hardware Config')");
      sql.execute("insert into cells (pid,x,y,w,h,comp,name,text,tag) values (" + id + ",5,11,2,1,'togglebutton','','Enable','jfc_config_value_str_hw_active')");
      sql.execute("insert into cells (pid,x,y,w,h,comp,name,text,func,arg) values (" + id + ",8,11,3,1,'button','','Comments','setPanel','jfc_config_iocomments')");
      sql.execute("insert into cells (pid,x,y,w,h,comp,name,text) values (" + id + ",1,12,2,1,'label','','DI:')");
      sql.execute("insert into cells (pid,x,y,w,h,comp,name,tag) values (" + id + ",4,12,6,1,'textfield','','jfc_config_value_str_hw_di')");
      sql.execute("insert into cells (pid,x,y,w,h,comp,name,text) values (" + id + ",1,13,2,1,'label','','DO:')");
      sql.execute("insert into cells (pid,x,y,w,h,comp,name,tag) values (" + id + ",4,13,6,1,'textfield','','jfc_config_value_str_hw_do')");
//    }
    ...
    sql.execute("insert into cells (pid,x,y,w,h,comp,name,text,style) values (" + id + ",14,1,1,1,'label','','Move:','smallfont')");
    sql.execute("insert into cells (pid,x,y,w,h,comp,name,text,func,style) values (" + id + ",15,1,1,1,'button','','!image:m_u','jfc_panel_editor_move_u','border')");
    sql.execute("insert into cells (pid,x,y,w,h,comp,name,text,func,style) values (" + id + ",16,1,1,1,'button','','!image:m_d','jfc_panel_editor_move_d','border')");
    sql.execute("insert into cells (pid,x,y,w,h,comp,name,text,func,style) values (" + id + ",17,1,1,1,'button','','!image:m_l','jfc_panel_editor_move_l','border')");
    sql.execute("insert into cells (pid,x,y,w,h,comp,name,text,func,style) values (" + id + ",18,1,1,1,'button','','!image:m_r','jfc_panel_editor_move_r','border')");
    sql.execute("insert into cells (pid,x,y,w,h,comp,name,text,style) values (" + id + ",20,1,1,1,'label','','Size:','smallfont')");
    sql.execute("insert into cells (pid,x,y,w,h,comp,name,text,func,style) values (" + id + ",21,1,1,1,'button','','!image:s_w_i','jfc_panel_editor_size_w_inc','border')");
    sql.execute("insert into cells (pid,x,y,w,h,comp,name,text,func,style) values (" + id + ",22,1,1,1,'button','','!image:s_w_d','jfc_panel_editor_size_w_dec','border')");
    sql.execute("insert into cells (pid,x,y,w,h,comp,name,text,func,style) values (" + id + ",23,1,1,1,'button','','!image:s_h_i','jfc_panel_editor_size_h_inc','border')");
    sql.execute("insert into cells (pid,x,y,w,h,comp,name,text,func,style) values (" + id + ",24,1,1,1,'button','','!image:s_h_d','jfc_panel_editor_size_h_dec','border')");
    ...
    sql.execute("insert into cells (pid,x,y,w,h,comp,name,text) values (" + id + ",0,1,1,1,'label','c0Lbl','0')");
    sql.execute("insert into cells (pid,x,y,w,h,comp,name,func) values (" + id + ",1,1,1,1,'light','c0','jfc_panel_props_c0')");
    sql.execute("insert into cells (pid,x,y,w,h,comp,name,text) values (" + id + ",2,1,1,1,'label','c1Lbl','1')");
    sql.execute("insert into cells (pid,x,y,w,h,comp,name,func) values (" + id + ",3,1,1,1,'light','c1','jfc_panel_props_c1')");
    sql.execute("insert into cells (pid,x,y,w,h,comp,name,text) values (" + id + ",4,1,1,1,'label','cnLbl','-1')");
    sql.execute("insert into cells (pid,x,y,w,h,comp,name,func) values (" + id + ",5,1,1,1,'light','cn','jfc_panel_props_cn')");

    sql.execute("insert into cells (pid,x,y,w,h,comp,name,text) values (" + id + ",0,2,1,1,'label','v0Lbl','Low')");
    sql.execute("insert into cells (pid,x,y,w,h,comp,name) values (" + id + ",1,2,1,1,'textfield','v0')");
    sql.execute("insert into cells (pid,x,y,w,h,comp,name,text) values (" + id + ",2,2,1,1,'label','v1Lbl','Mid')");
    sql.execute("insert into cells (pid,x,y,w,h,comp,name) values (" + id + ",3,2,1,1,'textfield','v1')");
    sql.execute("insert into cells (pid,x,y,w,h,comp,name,text) values (" + id + ",4,2,1,1,'label','v2Lbl','Max')");
    sql.execute("insert into cells (pid,x,y,w,h,comp,name) values (" + id + ",5,2,1,1,'textfield','v2')");

    sql.execute("insert into cells (pid,x,y,w,h,comp,name,text) values (" + id + ",0,3,2,1,'label','dir','Dir')");
    sql.execute("insert into cells (pid,x,y,w,h,comp,name,text,func) values (" + id + ",2,3,2,1,'togglebutton','h','Horz','jfc_panel_props_h')");
    sql.execute("insert into cells (pid,x,y,w,h,comp,name,text,func) values (" + id + ",4,3,2,1,'togglebutton','v','Vert','jfc_panel_props_v')");

    sql.execute("insert into cells (pid,x,y,w,h,comp,text) values (" + id + ",0,4,2,1,'label','Tag')");
    sql.execute("insert into cells (pid,x,y,w,h,comp,name) values (" + id + ",3,4,5,1,'textfield','tag')");
    sql.execute("insert into cells (pid,x,y,w,h,comp,text) values (" + id + ",0,5,2,1,'label','Press')");
    sql.execute("insert into cells (pid,x,y,w,h,comp,name) values (" + id + ",3,5,5,1,'textfield','press')");
    sql.execute("insert into cells (pid,x,y,w,h,comp,text) values (" + id + ",0,6,2,1,'label','Release')");
    sql.execute("insert into cells (pid,x,y,w,h,comp,name) values (" + id + ",3,6,5,1,'textfield','release')");
    sql.execute("insert into cells (pid,x,y,w,h,comp,text) values (" + id + ",0,7,2,1,'label','Click')");
    sql.execute("insert into cells (pid,x,y,w,h,comp,name) values (" + id + ",3,7,5,1,'textfield','click')");
    sql.execute("insert into cells (pid,x,y,w,h,comp,name,text,func) values (" + id + ",0,8,2,1,'button','','OK','jfc_panel_props_ok')");
    sql.execute("insert into cells (pid,x,y,w,h,comp,name,text,func) values (" + id + ",3,8,2,1,'button','','Cancel','jfc_panel_props_cancel')");
