...
public class SoundPanel extends javax.swing.JPanel {
  ...
  private void outputVolumeStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_outputVolumeStateChanged
    ...
    sink.volume = volume;
    ConfigApp.jbusClient.invoke("javaforce.jflinux.jfdesktop." + System.getenv("JID"), "soundSinkVolumeChanged", sidx, volume);
  ...
  private void inputVolumeStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_inputVolumeStateChanged
    ...
    ConfigApp.jbusClient.invoke("javaforce.jflinux.jfdesktop." + System.getenv("JID"), "soundSourceVolumeChanged", sidx, volume);
  ...
  private void setDefault() {
    ...
    switch (tab) {
      case 0:
        ...
        ConfigApp.jbusClient.invoke("javaforce.jflinux.jfdesktop." + System.getenv("JID"), "soundSinkPortChanged", sidx, port);
        break;
      case 1:
        ...
        ConfigApp.jbusClient.invoke("javaforce.jflinux.jfdesktop." + System.getenv("JID"), "soundSourcePortChanged", sidx, port);
        break;
      case 2:
        ...
        ConfigApp.jbusClient.invoke("javaforce.jflinux.jfdesktop." + System.getenv("JID"), "soundProfileChanged", cidx, profile);
        break;
    }
    listAll();
  }
