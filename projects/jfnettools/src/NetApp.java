...
public class NetApp extends javax.swing.JFrame implements WifiAnalyzer.Callback {
  ...
  private void initComponents() {
    ...
    wifi_table.setModel(new javax.swing.table.DefaultTableModel(
      ...
      new String [] {
        "SSID", "Freq", "Signal", "Authentication", "Encryption"
      }
    ) {
      ...
      public void run() {
        ...
        for(SSID ssid : ssids) {
          for(SSID.AP ap : ssid.aps) {
            model.addRow(new String[] {ssid.ssid, Integer.toString(ap.channel), Integer.toString(ap.dbm), ssid.auth, ssid.encryption});
          }
        }
