...
class RfbProto {
  ...
  RfbProto(String h, int p, VncViewer v) throws IOException {
    ...
    if (viewer.socketFactory == null) {
      ...
      try {
        ...
        SocketFactory factory = (SocketFactory) ctor.newInstance();
  ...
  final static int CTRL_MASK = InputEvent.CTRL_DOWN_MASK;
  final static int SHIFT_MASK = InputEvent.SHIFT_DOWN_MASK;
  final static int META_MASK = InputEvent.META_DOWN_MASK;
  final static int ALT_MASK = InputEvent.ALT_DOWN_MASK;
  ...
  void writeKeyEvent(KeyEvent evt) throws IOException {
    ...
    if ((key == 0xe5) || (key == 0xc5)
      ...
      if (!down && !brokenKeyPressed) {
        ...
        // a press. Fake it.
        eventBufLen = 0;
        writeModifierKeyEvents(evt.getModifiersEx());
