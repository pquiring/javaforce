...
public class PlayerApp extends javax.swing.JFrame {
  ...
  public PlayerApp() {
    ...
    setPosition();
    setTitle("jfDVR Player/" + service.ConfigService.version);
    if (args.length > 0) {
      String arg = args[0];
      ...
      GetNetworkSourceDialog dialog = new GetNetworkSourceDialog(frame, false);
      dialog.setVisible(true);
      if (!dialog.accepted) System.exit(0);
      panel.play(dialog.getURL());
    }
  }
