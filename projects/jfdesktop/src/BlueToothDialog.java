...
public class BlueToothDialog extends javax.swing.JFrame {
  ...
  private void scan() {
    ...
    if (!isBTEnabled()) {
      enabling = true;
      Dock.jbusServer.invoke(SystemBusNames.network, "enableBTdevice", deviceList[deviceIdx*2]);
  ...
  public void devices(String list) {
    ...
    if (deviceList.length > 2) {
      ...
      if (!isBTEnabled()) {
        ...
        Dock.jbusServer.invoke("javaforce.jflinux.jfnetworkmgr", "enableBTdevice", deviceList[0]);
      } else {
        setStatus("Status : Ready");
      }
    }
