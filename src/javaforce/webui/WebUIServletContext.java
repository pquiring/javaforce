...
public class WebUIServletContext {
  ...
  public WebUIServletContext(JFClassLoader loader, Object servlet) {
    ...
    try {
      ...
      connectServlet = server_cls.getMethod("connectServlet", String.class, String.class, InputStream.class, OutputStream.class, String[].class);
    } catch (Exception e) {
      JFLog.log(e);
    }
  }
  ...
  public void connectServlet(String server_host, String client_host, InputStream is, OutputStream os, String[] cookies) {
    try {
      connectServlet.invoke(server, server_host, client_host, is, os, cookies);
    } catch (Exception e) {
      JFLog.log(e);
    }
  }
