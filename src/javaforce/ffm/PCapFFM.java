...
public class PCapFFM implements PCapAPI {
  ...
  public String[] pcapListLocalInterfaces() { try { Arena arena = Arena.ofAuto(); FFMArray _ret_value_ = new FFMArray(); pcapListLocalInterfaces.invokeExact(_ret_value_.getUpcall(ffm, arena,"String"));return (String[])_ret_value_.getArray(); } catch (Throwable t) { JFLog.log(t);  return null;} }
  ...
  public byte[] pcapRead(long handle) { try { Arena arena = Arena.ofAuto(); FFMArray _ret_value_ = new FFMArray(); pcapRead.invokeExact(_ret_value_.getUpcall(ffm, arena,"Byte"),handle);return (byte[])_ret_value_.getArray(); } catch (Throwable t) { JFLog.log(t);  return null;} }
