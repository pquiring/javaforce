...
public class UIJNI implements UIAPI {
  ...
  public native long uiWindowCreate(int style, String title, int width, int height, long shared);
  ...
  public native void uiPollEvents(long id, int wait, UIEvents events);
