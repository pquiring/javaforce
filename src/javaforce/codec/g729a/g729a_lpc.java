...
final class g729a_lpc implements g729a_constants {
  ...
  static void g729a_lp_analysis(float[] fs, g729a_encode_speech var_g729a_encode_speech) {
                ...
                if (!(f_6_ <= 0.0F)) {
                  ...
                  if (!(f_6_ <= 0.0F)) {
                    ...
                    if (!(f_6_ <= 0.0F)) {
                      ...
                      f_6_ *= 1.0F - f * f;
                      if (!(f_6_ <= 0.0F)) {
                        float f_17_ = f_5_ + f_16_ - 1.0F;
                        float f_18_ = f_7_ + f_15_ - f_17_;
                        float f_19_ = f_9_ + f_14_ - f_18_;
                        float f_20_ = f_10_ + f_13_ - f_19_;
                        float f_21_ = f_11_ + f_12_ - f_20_;
                        ...
                        fs_3_[3] = f_20_;
                        fs_3_[4] = f_22_;
                        float f_23_ = f_5_ - f_16_ + 1.0F;
                        float f_24_ = f_7_ - f_15_ + f_23_;
                        float f_25_ = f_9_ - f_14_ + f_24_;
                        float f_26_ = f_10_ - f_13_ + f_25_;
                        float f_27_ = f_11_ - f_12_ + f_26_;
                        ...
                        int i = 0;
                        float f_30_ = 1.0F;
                        f_30_ = (g729a_tables.g729a_tab[0]);
                        float f_31_ = g729a_chebps(f_30_,
                                fs_29_);
                        for (int i_32_ = 1; i_32_ < 51;
                                i_32_++) {
                          float f_33_ = f_30_;
                          float f_34_ = f_31_;
                          f_30_ = (g729a_tables.g729a_tab[i_32_]);
                          f_31_ = g729a_chebps(f_30_,
                                  fs_29_);
                          if (f_34_ * f_31_
                                  <= 0.0F) {
                            for (int i_35_ = 0;
                              ...
                              float f_36_ = ((f_33_
                                      + f_30_)
                                      / 2.0F);
                              float f_37_ = (g729a_chebps(f_36_,
                                      fs_29_));
                              if (f_31_ * f_37_
                                      <= 0.0F) {
                                f_34_ = f_37_;
