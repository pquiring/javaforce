...
final class g729a_reconstruct implements g729a_constants {
  ...
  static void g729a_lspdec(g729a_decode_lp var_g729a_decode_lp,
    ...
    var_g729a_decode_lp.l_quant_past_frame_4 = var_g729a_decode_lp.l_quant_past_frame_3;
    var_g729a_decode_lp.l_quant_past_frame_3 = var_g729a_decode_lp.l_quant_past_frame_2;
    var_g729a_decode_lp.l_quant_past_frame_2 = var_g729a_decode_lp.l_quant_past_frame_1;
    ...
    for (int i_16_ = 0; i_16_ < 2; i_16_++) {
      ...
      for (int i_19_ = 0; i_19_ < 10; i_19_++) {
        fs_4_[i_5_ + i_19_] = (fs_17_[i_18_ + i_19_] * fs_12_[i_19_]
    ...
    for (int i_21_ = 0; i_21_ < 10; i_21_++) {
      var_g729a_decode_lp.q_quant_present_subframe_2[i_21_] = (float) Math.cos((double) fs_3_[i_21_]);
    }
  }
  ...
  static void g729a_lspdec_erased(g729a_decode_lp var_g729a_decode_lp) {
    ...
    for (int i_29_ = 0; i_29_ < 10; i_29_++) {
      fs[i_29_] = (fs_28_[i_29_] - fs_23_[i + i_29_]) * fs_26_[i_27_ + i_29_];
    }
    g729a_common.g729a_rearrange(fs, 0.0012207031F, 10);
    g729a_common.g729a_rearrange(fs, 6.1035156E-4F, 10);
    ...
    for (int i_30_ = 0; i_30_ < 10; i_30_++) {
      var_g729a_decode_lp.q_quant_present_subframe_2[i_30_] = (float) Math.cos((double) fs_22_[i_30_]);
    }
  }

  static void g729a_dec_lag3_1(G729aCode g729acode, g729a_decode_internal var_g729a_decode_internal,
    ...
    int i_33_ = (i_32_ >> 2 & 0x1 ^ i_32_ >> 3 & 0x1 ^ i_32_ >> 4 & 0x1
  ...
  static void g729a_dec_lag3_2(G729aCode g729acode, g729a_decode_internal var_g729a_decode_internal,
          g729a_decode_speech var_g729a_decode_speech) {
    float[] fs = var_g729a_decode_internal.v;
  ...
  static void g729a_dec_gain(g729a_decode_internal var_g729a_decode_internal,
    ...
    float f_55_ = ((0.68F * fs_53_[0] + 0.58F * fs_53_[1]
            ...
            / 20.0F);
    float f_56_ = (float) ((double) f * Math.exp((double) (2.3025851F * f_55_)));
    var_g729a_decode_speech.past_quan_gp = var_g729a_decode_internal.gp_quan = (g729a_tables.g729a_gbk1[i][0]
            + g729a_tables.g729a_gbk2[i_54_][0]);
    float f_57_ = (g729a_tables.g729a_gbk1[i][1]
            + g729a_tables.g729a_gbk2[i_54_][1]);
    var_g729a_decode_speech.past_quan_gc = var_g729a_decode_internal.gc_quan = f_56_ * f_57_;
    fs_53_[3] = fs_53_[2];
    fs_53_[2] = fs_53_[1];
    fs_53_[1] = fs_53_[0];
    fs_53_[0] = (float) (20.0 * Math.log((double) f_57_) * 0.4342944819032518);
  }

  static void g729a_reconstruct_speech(g729a_decode_internal var_g729a_decode_internal,
          g729a_decode_speech var_g729a_decode_speech,
    ...
    g729a_sinthesis_filter var_g729a_sinthesis_filter = var_g729a_decode_filters.sinthesis;
    for (int i = 0; i < 40; i++) {
